...
def getAllProduct():
    return requests.get("http://monserveur:5000/product/getProducts")


def getdProductDetails(name):
    return requests.get(f'http://monserveur:5000/product/details/{name}')


def addProduct(product):
    return requests.post("http://monserveur:5000/product/add", json=product)


def deleteProduct(name):
    return requests.delete(f'http://monserveur:5000/product/delete/{name}')
